    ...
    $(function() {
                ...
                success: function (result) {
                    ...
                    if (jsonData.length != 0) {
                        $.each(jsonData, function(index, val) {
                            ...
                            let editCellHtml = '<a class="btn btn-sm btn-info btn-block" href="branch-type/' + val.id + '" data-toggle="tooltip" title="{{ trans("usersmanagement.tooltips.edit") }}">{!! trans("organization.buttons.edit") !!}</a>';
        ...
        searchformInput.keyup(function(event) {
            if ($('#branch_search_box').val() != '') {
                ...
                resultsContainer.html('');
                usersTable.show();
                cardTitle.html("Showing All Branch Types");
                userPagination.show();
                usersCount.html(" ");
            };
        });
