            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {!! Form::open(array('route' => 'shipping.discharge-change', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <table id="myTable" class=" table order-list table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input  type="text" name="RCF_0" class="form-control">
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#addrow").on("click", function () {
                ...
                cols += '<td><input type="text" class="form-control"  name="RCF_' + counter + '"/></td>';
                cols += '<td><input type="text" class="form-control"  name="RCT_' + counter + '"/></td>';
