...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center">
            <a class="navbar-brand brand-logo" href=""><img src="{{ url('/') }}/images/traccular_logo_light.svg" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href=""><img src="{{ url('/') }}/images/traccular_logo_light_small.png" alt="logo" /></a>
        </div>
